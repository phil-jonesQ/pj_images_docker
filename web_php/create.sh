...
docker run -d --name=apache_server --restart=always --net pj_images_vlan200 --ip 192.168.200.1 -p 80:80 -v ~/Projects/docker/pj_images_docker/www/pj_images_003:/var/www/html:z -v ~/Projects/docker/pj_images_docker/www/assets:/var/www/html/assets pjimages001/apache_server
